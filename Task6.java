...
public class Task6 {
    ...
    public static void main(String[] args){
        ...
        do {
            ...
            drawCanvas();
            System.out.println("введите" + " "+ (isCurrentX ? "X" : "O"));
            int n = getNumber();
        ...
        drawCanvas();
        System.out.println();
        System.out.println("победил" + " " + (isCurrentX ? "X" : "O") + "!");
    }
    static int getNumber(){
        ...
        while (true){
            try {
                ...
                System.out.println("Выберите свободную ячейку и введите ее номер");
            } catch (NumberFormatException e) {
                System.out.println("Пожалуйста, введите номер ячейки");
            } catch (IOException e) {
            }
        }
    }
